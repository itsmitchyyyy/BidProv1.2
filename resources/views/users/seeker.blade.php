...
<div class="card-block">
  ...
  <button type="button" class="btn btn-info text-uppercase waves-effect waves-light float-right" style="background-color:#ee4b28;border:2px solid #ee4b28;" data-toggle="modal" data-target="#viewBidder{{ $project->project_id }}">View More</button>
</div>
</div>
