           ...
           <div class="col-md-12 col-lg-4">
               <div class="white-box">
                   ...
                   <div class="message-center">
                       ...
                       <a href="#">
                           <div class="user-img"> <img src="/img/users/genu.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                           <div class="mail-contnet">
               ...
               <div class="white-box">
                   ...
                   <div class="chat-box">
                       <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                           <li>
                               <div class="chat-image"> <img alt="male" src="/img/users/sonu.jpg"> </div>
                               <div class="chat-body">
                                   <div class="chat-text">
                                       <h4>Sonu Nigam</h4>
                                       <p> Hi, All! </p>
                           ...
                           <li class="odd">
                               <div class="chat-image"> <img alt="Female" src="/img/users/genu.jpg"> </div>
                               <div class="chat-body">
                                   <div class="chat-text">
                                       <h4>Genelia</h4>
                           ...
                           <li>
                               <div class="chat-image"> <img alt="male" src="/img/users/ritesh.jpg"> </div>
                               <div class="chat-body">
                                   <div class="chat-text">
                                       <h4>Ritesh</h4>
