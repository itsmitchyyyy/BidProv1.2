...
<div class="navbar-header" style="background-color:#ccc"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg" href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
    <div class="top-left-part" style="background-color:#C0C0C0"><a class="logo" href="{{ route('admin') }}" style="padding-left:20%;"><b><img src="/img/bidprologo.png" alt="home" style="width:120px;"  /></span></a></div>
    <ul class="nav navbar-top-links navbar-left hidden-xs">
        
       <!-- <li>
            <form role="search" class="app-search hidden-xs" style="padding-left: 20px;">
